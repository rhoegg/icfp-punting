...
#         "mines"=>[1,5]}
#     setup_message = {:setup, 0, 2, game_map}
#     game = DataStructure.process(setup_message)
...
# =======
#     # blah = MineRoutes.our_info(game_data) |> IO.inspect
# >>>>>>> Break apart data processing of start to be used more easily and efficiently from strategies
